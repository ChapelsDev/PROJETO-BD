...
namespace TechHouse
{
    public partial class Form1 : Form
    {
        ...
        private void button33_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o de editar
        {
        ...
        private void button34_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o de editar
        {
        ...
        private void button35_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o de editar
        {
        ...
        private void button36_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o editar
        {
            if (dataGridView4.SelectedRows.Count > 0)
            {
                ...
                {
                    if (i == 5) { continue; } //skip the sixth column porque n�o � textbox
        ...
        private void button37_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o editar
        {
            if (dataGridView5.SelectedRows.Count > 0)
            {
                ...
                {
                    if (i == 1) { continue; } //skip the second column porque n�o � textbox
        ...
        private void button38_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o editar
        {
            if (dataGridView6.SelectedRows.Count > 0)
            {
                ...
                {
                    if (i == 3) { continue; } //skip the fourth column porque n�o � textbox
        ...
        private void button39_Click_1(object sender, EventArgs e) //logica para quando clica no bot�o editar
        {
            if (dataGridView7.SelectedRows.Count > 0)
            {
                ...
                {
                    if (i == 4) { continue; } //skip the fifth column porque n�o � textbox
        ...
        {
            if (dataGridView8.SelectedRows.Count > 0) //logica para quando clica no bot�o editar
            {
                // Assume that the ID of the user is in the first column of the DataGridView
                ...
                {
                    if (i == 2) { continue; } //skip the second column porque n�o � textbox
